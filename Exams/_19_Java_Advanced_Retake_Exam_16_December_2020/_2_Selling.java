...
public class _2_Selling {
    public static void main(String[] args) {
        ...
        int [] pillarsLocation = getLocation(matrix, 'O');
        int firstPillarRow = pillarsLocation[0];
        int firstPillarCol = pillarsLocation[1];
        int secondPillarRow = pillarsLocation[2];
        int secondPillarCol= pillarsLocation[3];
